...
type DPDKonmetalClient interface {
	...
	GetLBVIPBackends(ctx context.Context, in *LBMsg, opts ...grpc.CallOption) (*LBBackendMsg, error)
...
func (c *dPDKonmetalClient) GetLBVIPBackends(ctx context.Context, in *LBMsg, opts ...grpc.CallOption) (*LBBackendMsg, error) {
...
type DPDKonmetalServer interface {
	...
	GetLBVIPBackends(context.Context, *LBMsg) (*LBBackendMsg, error)
...
func (UnimplementedDPDKonmetalServer) GetLBVIPBackends(context.Context, *LBMsg) (*LBBackendMsg, error) {
...
func _DPDKonmetal_GetLBVIPBackends_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DPDKonmetalServer).GetLBVIPBackends(ctx, req.(*LBMsg))
	}
	return interceptor(ctx, in, info, handler)
}
